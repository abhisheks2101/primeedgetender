...
from app.api.routes import admin, auth, companies, health, tender_collection, tender_documents, tender_duplicates, tender_sources, tenders
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app.include_router(tender_documents.router, prefix="/api")
